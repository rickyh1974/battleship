...
public class Sauvegarde {
	 ...
	 * Constructeur
	 */
	public Sauvegarde(String partieXML, String path, String nomFichier) {
		this.partieXML=partieXML;
		this.path=path;
		this.nomFichier=nomFichier;
		sauvegardeXML(partieXML,path,nomFichier);	
	 ...
	 * 
	 */
	public static boolean sauvegardeXML(String partieXML, String path, String nomFichier) {
		// TODO 
